...
namespace BlazorServer.Business.BLL
{
    public class EntidadSamo : IEntidadSamo
    {
        ...
        public async Task<PaginacionResult<EntidadDto>> ObtenerEntidades(string identificacion, long? documentoIdentidadID, int pagina, int tamañoPagina, long operacionId, long? ClaseId = null)
        {
